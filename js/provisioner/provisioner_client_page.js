...
let clientName = document.querySelector('body > div.container > h3.pull-left');;
changeTabTitle(`${clientName.textContent} | Provisioner`);
...
window.onload = function () {
    ...
    var favColor = 'rgb(185, 185, 185)';
    changeFavicon(favColor);
};